module.exports = (function (e, t) {
...
})(
    {
        ...
        122: function (e, t, r) {
            ...
            const o = 'autorebase:non-rebaseable';
            class testableEligiblePullRequestsRetriever_TestableEligiblePullRequestsRetriever {
                ...
                static isEligible(e) {
                    if (!e.labels.includes(s)) {
                        Object(i.info)(`PR #${e.number} does not have the '${s}' label.`);
                        return false;
                    }
                    if (e.draft) {
            ...
            const a = ['behind', 'blocked', 'clean', 'dirty', 'unknown', 'unstable'];
            ...
            class labeler_Labeler {
                ...
                async addLabels(e, t, r) {
                    const n = e.filter((e) => !e.rebaseable && !e.labels.includes(o) && e.labels.includes(s));
                    if (n.length > 0) {
                        await this.createNonRebaseableLabel(t, r);
                    }
                    await Promise.all(
                        n.map((e) => {
                            Object(i.info)(`Adding '${o}' label to PR #${e.number}.`);
                            return this.labelPullRequestService.addLabel(t, r, e.number, o);
                        }),
                    );
                }
                ...
                async removeLabels(e, t, r) {
                    const n = e.filter((e) => e.rebaseable && e.labels.includes(o));
                    await Promise.all(
                        n.map((e) => {
                            Object(i.info)(`Removing '${o}' label from PR #${e.number}.`);
                            return this.labelPullRequestService.removeLabel(t, r, e.number, o);
                        }),
                    );
                }
            }
